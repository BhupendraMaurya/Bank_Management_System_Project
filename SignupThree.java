...
//submit button ke click pr action chahiye isaliye action listener implement kr rha
public class SignupThree extends JFrame implements ActionListener{
    ...
    SignupThree(String formno){
        ...
        services.setBounds(100,450,280,30);
        add(services);
        ...
        c7 = new JCheckBox("I hereby declare that the above entered information are correct to the best of my knowledge");
    ...
    public void actionPerformed(ActionEvent ae){
        if(ae.getSource() == submit){
            ...
            // to put value in databse we have to do exception hndling bcz there may occur run time errors
            
            try{
                if(accountType.equals("")){ // agr accounttype field empty h to ye prompt show hoga aur isko fill krne ke bad hi next move kr skte h
